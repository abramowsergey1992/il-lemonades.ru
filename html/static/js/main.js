...
!(function (e, t, n, o, r) {
	...
	function bn(e, t) {
		return (t = 1 < arguments.length ? t : Nt)
			? t.querySelectorAll(e)
			: null;
	}
	function wn(e) {
	...
	function Kn(e, t, n) {
		...
		(n = void 0 === n ? {} : n),
			"function" == typeof Rt.CustomEvent
				...
				: (o = Nt.createEvent("CustomEvent")).initCustomEvent(
						t,
						!0,
						!0,
						n
	...
	return (
		...
		function (e, E) {
			...
			if (!yn(u, Wt)) {
				...
				var m,
					...
					H = {
						...
						touchstart:
							"ontouchstart" in Rt ? "touchstart" : B.down,
					},
					I =
						...
						(h.destroy = function (e) {
							J(!1, "internal"),
								...
								e &&
									...
									bn("img[data-srcset]").forEach(function (
										e
									) {
										De(e, "srcset");
									}),
				...
				e
					...
					: (ne(!1),
					  (function () {
							if (o || l) {
								E.autoScrolling &&
									(L.removeEventListener(H.touchmove, Te, {
										passive: !1,
									}),
									L.removeEventListener(H.touchmove, Ae, {
										passive: !1,
			...
			function we(e, t) {
				return (
					E.navigationTooltips[e] || E.anchors[e] || t + " " + (e + 1)
				);
			}
			function ye() {
				var e,
			...
			function Fe(e) {
				...
				bn("video, audio", t).forEach(function (e) {
					...
					bn('iframe[src*="youtube.com/embed/"]', t).forEach(
						function (e) {
			...
			function st(e) {
				...
				return (
					Rn(e, Dt), xn(e, { "-webkit-transition": t, transition: t })
				);
			}
			function ct(e) {
				return In(e, Dt);
...
$(document).on("click", ".js-changer-link", function () {
	$(this).toggleClass("_active");
});

function aboutAnimation() {
	var aboutEl = $(".js-about-el");
	...
	if (aboutEl.length) {
		...
		aboutEl.each(function () {
			var _this = $(this);
			var randomResult = random(6000, 8000);
			positionGen(_this, randomResult);
...
$(document).on("click", ".js-ajax-link", function () {
	...
	var url = $(this).attr("href"),
		thisPageUrl = window.location.pathname;

	if (url == thisPageUrl) {
		return false;
	}
	ajax.init(url, $(this), false);
	return false;
});

$("body").on("click", ".n-about-btn__inside", function () {
	var str = window.location.href;
	if (str.includes("type-2")) {
		console.log("Взаимодействие со слайдами t2b");
		window.dataLayer = window.dataLayer || [];
		dataLayer.push({
			event: "conversion",
			eventCategory: "conversion",
			eventAction: "go_to_shop",
		});
		ym(87767080, "reachGoal", "ym_goal__conversion__type_2__go_to_shop");
	}
});

$("body").on("click", ".n-products-slider-nav__btn", function () {
	var str = window.location.href;
	if (str.includes("type-2")) {
		console.log("Взаимодействие со слайдами t2c");
		window.dataLayer = window.dataLayer || [];
		dataLayer.push({
			event: "conversion",
			eventCategory: "conversion",
		...
		ym(87767080, "reachGoal", "ym_goal__conversion__type_2__click_product");
	}
});

$("body").on("click", ".n-products-slider-prev__box", function () {
	var str = window.location.href;
	if (str.includes("type-2")) {
		console.log("Взаимодействие со слайдами t2d");
		window.dataLayer = window.dataLayer || [];
		dataLayer.push({
			event: "conversion",
			eventCategory: "conversion",
...
$("body").on("click", ".n-about-btn__inside", function () {
	var str = window.location.href;
	if (str.includes("type-2")) {
		console.log("Взаимодействие со слайдами t2f");
		window.dataLayer = window.dataLayer || [];
		dataLayer.push({
			event: "conversion",
			eventCategory: "conversion",
...
//   var str = window.location.href;
//     if(str.includes('type-2') && hjf2 == 0){
//         hjf2++;
//         ym(87767080,'hit','/type-2');
//         ym(87767080,'reachGoal','ym_goal__conversion__type_2__page_view');
//         console.log( "readyt2!" );
//     }else if(str.includes('type-1') && hjf1 == 0){
//       hjf1++;
//       ym(87767080,'hit','/type-1');
//       ym(87767080,'reachGoal','ym_goal__conversion__type_1__page_view');
//       console.log( "ready!t1" );
//     }
// });
var hjf1 = 0;
var hjf2 = 0;
const findAndClick = (delay) => {
	var str = window.location.href;
	if (str.includes("type-2") && hjf2 == 0) {
		hjf2++;
		ym(87767080, "hit", "/type-2");
...
$("body").on("click", ".products-slider-prev__box", function () {
	var str = window.location.href;
	if (str.includes("type-1")) {
		console.log("Взаимодействие со слайдами t1f");
		window.dataLayer = window.dataLayer || [];
		dataLayer.push({
			event: "conversion",
			eventCategory: "conversion",
		...
		ym(87767080, "reachGoal", "ym_goal__conversion__type_1__click_product");
	}
});

$("body").on("click", ".products-slider-nav__btn", function () {
	var str = window.location.href;
	if (str.includes("type-1")) {
		console.log("Взаимодействие со слайдами t1d");
		window.dataLayer = window.dataLayer || [];
		dataLayer.push({
			event: "conversion",
			eventCategory: "conversion",
...
$("body").on("click", ".about-btn__inside", function () {
	var str = window.location.href;
	if (str.includes("type-1")) {
		console.log("Взаимодействие со слайдами t1b");
		window.dataLayer = window.dataLayer || [];
		dataLayer.push({
			event: "conversion",
			eventCategory: "conversion",
		...
		ym(87767080, "reachGoal", "ym_goal__conversion__type_1__go_to_shop");
	}
});
...
//             ajax.init(url, $(this), true);
//         },false);
//     }, 1);
// }

var ajax = {
	init: function (url, linkPressed, backTrigger) {
	...
	switchPush: function () {
		...
		var htmlSource = $(this.data);
		var includeContent = htmlSource.find(this.container).html();
		var timeout = 600;
		...
		var pageTitle = htmlSource.filter("title").text();

		if (!this.backTrigger) {
			document.title = pageTitle;
			if (typeof history.pushState != "undefined") {
				history.pushState(this.data, pageTitle, this.url);
			}
		}

		setTimeout(function () {
			$(ajax.container).html(includeContent);

			if ($('body[class*="fp-viewing-"]').length) {
			...
			setTimeout(function () {
				...
				promoSlider();
				startBox();
				$.fn.fullpage.moveTo(locationHash);
			}, 50); // 2500
		}, timeout);
	},
};
...
$(document).on("click", ".js-n-products-slider-link", function () {
	$(this)
		.closest(".js-n-products-slider-box")
		.find(".js-n-products-slider-link")
		.removeClass("_active");
	$(this).addClass("_active");
	$(this)
		.closest(".js-n-products-slider-box")
		.find(".js-n-products-slider-el")
		.removeClass("_active");
	$(this)
		.closest(".js-n-products-slider-box")
		.find(".js-n-products-slider-el")
...
$(document).on("click", ".js-products-slider-link", function () {
	$(this)
		.closest(".js-products-slider-box")
		.find(".js-products-slider-link")
		.removeClass("_active");
	$(this).addClass("_active");
	$(this)
		.closest(".js-products-slider-box")
		.find(".js-products-slider-el")
		.removeClass("_active");
	$(this)
		.closest(".js-products-slider-box")
		.find(".js-products-slider-el")
...
// js-products-slider
// js-products-slider-nav

// js-promo-slider

function productsSlider() {
	if ($(".js-products-slider").length) {
		var galleryThumbs = new Swiper(".js-products-slider-prev", {
			spaceBetween: 0,
			slidesPerView: "auto",
			watchSlidesVisibility: true,
			watchSlidesProgress: true,
			...
			on: {
				slideChange: function () {
					// galleryTop.slideTo(galleryThumbs.realIndex, 700, false);
				},
			},
			breakpoints: {
				992: {
		...
		var galleryTop = new Swiper(".js-products-slider", {
			spaceBetween: 0,
			speed: 700,
			loop: true,
			navigation: {
...
function promoSlider() {
	if ($(".js-promo-slider").length) {
		var galleryThumbs = new Swiper(".js-promo-slider-min", {
			spaceBetween: 0,
			slidesPerView: 1,
			watchSlidesVisibility: true,
			watchSlidesProgress: true,
			...
			speed: 700,
			pagination: {
				el: ".js-promo-slider-min-pagination",
				type: "bullets",
				clickable: true,
			},
			on: {
		...
		var galleryTop = new Swiper(".js-promo-slider", {
			spaceBetween: 0,
			speed: 700,
			thumbs: {
				swiper: galleryThumbs,
...
function startBox() {
	if ($(".js-start-box").length) {
		$(document).on(
			{
				mouseover: function () {
					$(".js-start-box").addClass("_transform-l");
				},
				mouseout: function () {
					$(".js-start-box").removeClass("_transform-l");
				},
			},
			".js-start-img-right-box"
		);
	}
}
startBox();
