...
function aboutAnimation() {
    ...
    if (aboutEl.length) {
        ...
        function positionGen(el, num) {
            var x = random(-30, 30);
            var y = random(-30, 30);
            el.css({'transform': 'translate(' + x + 'px, ' + y + 'px)', 'transition-duration': num + 'ms'});
        }
...
$(document).on('click', '.js-n-products-slider-link', function() {
    $(this).closest('.js-n-products-slider-box').find('.js-n-products-slider-link').removeClass('_active');
    $(this).addClass('_active');
    $(this).closest('.js-n-products-slider-box').find('.js-n-products-slider-el').removeClass('_active');
    $(this).closest('.js-n-products-slider-box').find('.js-n-products-slider-el').eq($(this).parent().index()).addClass('_active');
})

$(document).on('click', '.js-products-slider-link', function() {
    $(this).closest('.js-products-slider-box').find('.js-products-slider-link').removeClass('_active');
    $(this).addClass('_active');
    $(this).closest('.js-products-slider-box').find('.js-products-slider-el').removeClass('_active');
    $(this).closest('.js-products-slider-box').find('.js-products-slider-el').eq($(this).parent().index()).addClass('_active');
})
